...
let s:p.normal.left = [ [ s:white2, s:black ], [ s:magenta, s:black ] ]
let s:p.normal.right = [ [ s:cyan2, s:black ], [ s:magenta2, s:black ] ]
let s:p.insert.left = [ [ s:red2, s:black ], [ s:magenta, s:black ] ]
let s:p.insert.right = [ [ s:red2, s:black ], [ s:magenta2, s:black ] ]
